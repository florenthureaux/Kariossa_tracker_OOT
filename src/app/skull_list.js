...
exports.Skull_Total = [
    ...
    { id: 22, name: 'Forest Temple GS Raised Island Courtyard', data: false, requirement: "((has_minuet_of_forest || has_saria_song) && has_hookshot && ((has_bow || has_song_of_time) || ((has_key_forest >= 1) && has_hover_boots))) || ((has_minuet_of_forest || has_saria_song) && has_hookshot && has_bow && has_strength1 && has_hover_boots)" },
    { id: 23, name: 'Forest Temple GS Level Island Courtyard', data: false, requirement: "((has_minuet_of_forest || has_saria_song) && has_hookshot && (((has_key_forest >= 1) && has_hover_boots) || ((has_key_forest >= 2) && has_strength1))) || ((has_minuet_of_forest || has_saria_song) && has_hookshot && has_bow && has_strength1 && has_hover_boots)" },
    { id: 24, name: 'Forest Temple GS Basement', data: false, requirement: "((has_minuet_of_forest || has_saria_song) && has_hookshot && has_bow && has_strength1 && has_key_forest > 4) || ((has_minuet_of_forest || has_saria_song) && has_hookshot && has_bow && has_strength1 && has_hover_boots)" },
    /*  Fire Temple  */
    ...
    { id: 26, name: 'Fire Temple GS Song of Time Room', data: false, requirement: "((has_bolero_of_fire || ((has_hookshot || has_hover_boots) && (has_strength1 || has_bomb || has_bow))) && (has_key_fire >= 1) && has_song_of_time) || (has_hookshot && has_bomb && has_hammer && has_bow && has_hover_boots && (has_tunic_goron || has_wallet200) && has_strength1)" },
    { id: 27, name: 'Fire Temple GS Boulder Maze', data: false, requirement: "((has_bolero_of_fire || (has_hookshot || has_hover_boots)) && (has_key_fire >= 3) && has_strength1 && has_bomb && (has_tunic_goron || has_wallet200)) || (has_hookshot && has_bomb && has_hammer && has_bow && has_hover_boots && (has_tunic_goron || has_wallet200) && has_strength1)" },
    { id: 28, name: 'Fire Temple GS Scarecrow Climb', data: false, requirement: "(has_hookshot && (has_key_fire > 4) && has_strength1 && (has_tunic_goron || has_wallet200)) || (has_hookshot && has_bomb && has_hammer && has_bow && has_hover_boots && (has_tunic_goron || has_wallet200) && has_strength1)" },
    { id: 29, name: 'Fire Temple GS Scarecrow Top', data: false, requirement: "(has_hookshot && (has_key_fire > 4) && has_strength1 && (has_tunic_goron || has_wallet200)) || (has_hookshot && has_bomb && has_hammer && has_bow && has_hover_boots && (has_tunic_goron || has_wallet200) && has_strength1)" },
    /*  Water Temple  */
    { id: 30, name: 'Water Temple GS Behind Gate', data: false, requirement: "has_hookshot && has_iron_boots && has_bomb & has_zelda_lullaby" },
    { id: 31, name: 'Water Temple GS Near Boss Key Chest', data: false, requirement: "(has_hookshot && has_iron_boots && has_bomb && has_strength1 && (has_key_water >= 4) && has_zelda_lullaby) || (has_longshot && has_bomb && has_iron_boots && has_bow && has_zelda_lullaby && has_strength1)" },
    { id: 32, name: 'Water Temple GS Central Pillar', data: false, requirement: "(((has_hookshot && has_farore_wind && has_magic) || has_longshot) && has_iron_boots && ((has_key_water >= 5) || has_bow || has_dins) && has_zelda_lullaby) || (has_longshot && has_bomb && has_iron_boots && has_bow && has_zelda_lullaby && has_strength1)" },
    { id: 33, name: 'Water Temple GS Falling Platform Room', data: false, requirement: "(has_longshot && has_iron_boots && (has_key_water >= 4) && has_zelda_lullaby) || (has_longshot && has_bomb && has_iron_boots && has_bow && has_zelda_lullaby && has_strength1)" },
    { id: 34, name: 'Water Temple GS River', data: false, requirement: "(has_longshot && has_iron_boots && (has_key_water >= 5) && has_zelda_lullaby && has_song_of_time) || (has_longshot && has_bomb && has_iron_boots && has_bow && has_zelda_lullaby && has_strength1 && has_song_of_time)" },
    /*  Spirit Temple  */
    ...
    /*  Shadow Temple  */
    { id: 40, name: 'Shadow Temple GS Like Like Room', data: false, requirement: "has_nocturne_of_shadow && has_dins && has_magic && has_hover_boots && has_bomb" },
    { id: 41, name: 'Shadow Temple GS Falling Spikes Room', data: false, requirement: "has_nocturne_of_shadow && has_dins && has_magic && has_hover_boots && has_bomb && has_hookshot" },
    { id: 42, name: 'Shadow Temple GS Single Giant Pot', data: false, requirement: "(has_nocturne_of_shadow && has_dins && has_magic && has_hover_boots && has_bomb && has_hookshot && (has_key_shadow >= 2)) || (has_nocturne_of_shadow && has_dins && has_magic && has_hover_boots && has_bomb && has_hookshot && has_strength1)" },
    { id: 43, name: 'Shadow Temple GS Near Ship', data: false, requirement: "(has_nocturne_of_shadow && has_dins && has_magic && has_hover_boots && has_bomb && has_longshot && (has_key_shadow >= 4)) || (has_nocturne_of_shadow && has_dins && has_magic && has_hover_boots && has_bomb && has_longshot && has_strength1)" },
    { id: 44, name: 'Shadow Temple GS Triple Giant Pot', data: false, requirement: "(has_nocturne_of_shadow && has_dins && has_magic && has_hover_boots && has_bomb && has_hookshot && (has_key_shadow >= 4)) || (has_nocturne_of_shadow && has_dins && has_magic && has_hover_boots && has_bomb && has_longshot && has_strength1)" },
    /*  ALL overworld skull  */
    /*  Kokiri Forest  */
