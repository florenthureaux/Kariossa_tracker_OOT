...
import { Skull_total } from './app/skull';
import { Skull_Total } from './app/skull_list';
import { ITEMS1, KEY_DUNGEON, SONG1, SONG2 } from './app/item_list';
import { REWARDS1, REWARDS2 } from './app/item_list';
import { ITEMS2 } from './app/item_list';
...
document.addEventListener('DOMContentLoaded', (event) => {
  ...
  var song1 = SONG1;
  var song2 = SONG2;
  var key_dungeon = KEY_DUNGEON;
  var reward1 = REWARDS1;
  var reward2 = REWARDS2;
  var skull_total = Skull_Total;
  skull_in_logic()
item1.forEach(element => {
  ...
  function onitemrightclick1(){
    ...
    switch (id) {
      case 1:
        var image_upgrade = document.getElementById("stick_upgrade") as HTMLImageElement;
      ...
      break;
      case 2:
        var image_upgrade = document.getElementById("nut_upgrade") as HTMLImageElement;
      ...
      break;
      case 3:
        var image_upgrade = document.getElementById("bomb_upgrade") as HTMLImageElement;
      ...
      break;
      case 4:
        var image_upgrade = document.getElementById("bow_upgrade") as HTMLImageElement;
...
item2.forEach(element => {
  ...
  function onitemrightclick2(){
    ...
    switch (id) {
      case 10:
        var image_upgrade = document.getElementById("slingshot_upgrade") as HTMLImageElement;
      ...
      break;
      case 13:
        var image_upgrade = document.getElementById("hookshot_upgrade") as HTMLImageElement;
      ...
      break;
      case 11:
        var image_upgrade = document.getElementById("ocarina_upgrade") as HTMLImageElement;
...
item4.forEach(element => {
  ...
  function onitemrightclick4(){
    ...
    switch (id) {
      case 28:
        var image_upgrade = document.getElementById("strength_upgrade") as HTMLImageElement;
        ...
        break;
      case 29:
        var image_upgrade = document.getElementById("scale_upgrade") as HTMLImageElement;
        ...
        break;
      case 30:
         var image_upgrade = document.getElementById("magic_upgrade") as HTMLImageElement;
      ...
      break;
      case 31:
        var image_upgrade = document.getElementById("wallet_upgrade") as HTMLImageElement;
...
item5.forEach(element => {
  ...
  function onitemrightclick5(){
    ...
    switch (id) {
      case 39:
        var image_upgrade = document.getElementById("mask_upgrade") as HTMLImageElement;
...
reward1.forEach(element => {
  ...
  function onrewardrightclick(){
    var image_upgrade = document.getElementById("key_forest") as HTMLImageElement;
    get_next_med_stone(element.id);
  
  }
});
reward2.forEach(element => {
  document.getElementById(element.id.toString())!.addEventListener('contextmenu', onrewardrightclick, false);
  function onrewardrightclick(){
    get_next_med_stone(element.id); 
  }
});
function get_next_med_stone(id: number){
  var image_upgrade = document.getElementById("med_stone_"+id) as HTMLImageElement;
...
function key_on_click(id: number){
  ...
  if (has_key_fire < 8 && id == 67){
    ...
    var image_upgrade = document.getElementById("key_fire") as HTMLImageElement;
    has_key_fire += 1;
  ...
  if (has_key_water < 5 && id == 69){
    ...
    var image_upgrade = document.getElementById("key_water") as HTMLImageElement;
    has_key_water += 1;
  ...
  if (has_key_shadow < 5 && id == 71){
    ...
    var image_upgrade = document.getElementById("key_shadow") as HTMLImageElement;
    has_key_shadow += 1;
  ...
  if (has_key_spirit < 5 && id == 73){
    ...
    var image_upgrade = document.getElementById("key_spirit") as HTMLImageElement;
    has_key_spirit += 1;
...
// SKULL SUM :
function sum_skull(skull_total: Skull_total[]){
  skull_compt = 0;
  skull_total.forEach(element => {
